...
def runSimulation(prms , mats):
    ...
    for tt in range(0, int(total_ms)):
        ...
        if pall[tt] >= 1:
            ...
            L_len_v1 = random.randrange(prms['N_v1']*prms['L_range_v1'][0], prms['N_v1']*prms['L_range_v1'][1] + 1)
            L_len_s1 = random.randrange(prms['N_s1']*prms['L_range_s1'][0], prms['N_s1']*prms['L_range_s1'][1] + 1)
            ...
            if corrFlag: 
                ...
                v1[eventID_v1, 0] = prms['L_amp_v1']; s1[eventID_s1, 0] = prms['L_amp_s1'];
                L_dur_v1_counter = round(np.random.normal(prms['L_dur_v1'], prms['L_dur_v1'] * 0.1))
