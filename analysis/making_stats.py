...
import matplotlib
# matplotlib.use('Agg')
# import analysis.auxiliary_stats_functions
# reload(auxiliar_stats_functions)
from analysis.auxiliary_stats_functions import circular_array, min_distance, compute_center, compute_topography, common_elements
...
def making_stats(path, W_v1, W_s1, w_thres_activation, N_v1):
    ...
    align_v1, align_s1, topo_v1, topo_s1, spars_v1, spars_s1 = compute_topography(W_active_v1, W_active_s1, N_v1)
    ...
    plt.close()
    output_data = [rf_size_v1, spars_v1, topo_v1, align_v1,
